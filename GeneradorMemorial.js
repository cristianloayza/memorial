...
function GenerarMemorial(){
			...
			var ObjetoImagen = new Image();
				...
				ContextoCanvas.lineWidth  = 0.5;
				ContextoCanvas.font = '10pt sans-serif';
				...
				ContextoCanvas.strokeText(textArriba, x, 240);
				ContextoCanvas.fillText(textArriba, x, 240);
	};
...
for(i=0;i<imagen.length;i++){
	imagen[i].onclick = function() { document.getElementById("image").src=this.src;GenerarMemorial(); };
}
